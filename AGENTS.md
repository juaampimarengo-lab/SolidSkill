# AGENTS.md — Permanent Instructions for Solid Skill

This file governs every Codex session working in this repository. These
...
(`AGENTS.md` and `docs/`). No application code, no `package.json`, no
